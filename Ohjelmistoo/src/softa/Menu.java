...
public class Menu extends Application {
	...
	static String salis="DBA123"; // näihin kun laittaa nyt oman kannan tiedot nii se yhistää siihen suoraa. Helpottaa testailua
	static Stage stg;
	@FXML
	Button nappi;
	...
	public void laskut(ActionEvent event) throws IOException {
		changeScene("Laskutus.fxml");
	}

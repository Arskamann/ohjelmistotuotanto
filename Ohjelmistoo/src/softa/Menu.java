...
public class Menu extends Application {
    ...
    public void start(Stage alku) {
          ...
          listView.getItems().add("M�kit");
          listView.getItems().add("Toiminta-alueet");
          listView.getItems().add("Laskutus");
          listView.setPrefSize(100, 150);
        
          
          listView.setOnMouseReleased((EventHandler<? super MouseEvent>) new EventHandler<Event>() { // t�ss� avataan sit eri n�kym�t ??? esimerkki vasta...
     ...
     //testii wtf!!
        ...
        alku.setTitle("M�kkivaraus softa !!!");
        alku.setScene(kehys);
        alku.show();
    }
